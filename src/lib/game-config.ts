...
export const ARENA_TIERS: ArenaTier[] = [
  ...
  { id: 'tier-1',  name: 'Scrap Alley',      buyIn: 10,          description: 'The starting proving grounds. Low stakes, soft competition, perfect for learning the ropes.',            difficulty: 'Beginner',    color: 'bg-emerald-500/10 border-emerald-500/30 text-emerald-400', accentColor: '#10b981', borderAccent: '#059669', botsCount: 150, rewardMultiplier: 1.0 },
  { id: 'tier-2',  name: 'Rust Market',       buyIn: 20,          description: 'A scrappy underground market arena. Slightly tougher bots patrol the dimly lit corridors.',               difficulty: 'Beginner',    color: 'bg-emerald-500/10 border-emerald-500/30 text-emerald-400', accentColor: '#34d399', borderAccent: '#10b981', botsCount: 150, rewardMultiplier: 1.1 },
  { id: 'tier-3',  name: 'Copper Lane',        buyIn: 40,          description: 'Warm copper-lit corridors. Bots here move a bit faster — stay sharp.',                                difficulty: 'Beginner',    color: 'bg-emerald-400/10 border-emerald-400/30 text-emerald-300', accentColor: '#4ade80', borderAccent: '#22c55e', botsCount: 150, rewardMultiplier: 1.2 },
  { id: 'tier-4',  name: 'Neon Grid',          buyIn: 75,          description: 'A glowing synthwave arena where speed is key. Pulsing neon borders and quick bots.',                  difficulty: 'Beginner',    color: 'bg-cyan-500/10 border-cyan-500/30 text-cyan-400',     accentColor: '#06b6d4', borderAccent: '#0891b2', botsCount: 150, rewardMultiplier: 1.5 },
  { id: 'tier-5',  name: 'Iron District',     buyIn: 150,         description: 'Industrial zone with moderate competition and steady food flow. Iron walls glow faintly.',            difficulty: 'Beginner',    color: 'bg-cyan-500/10 border-cyan-500/30 text-cyan-400',     accentColor: '#22d3ee', borderAccent: '#06b6d4', botsCount: 150, rewardMultiplier: 1.8 },
  { id: 'tier-6',  name: 'Bronze Arena',       buyIn: 300,         description: 'The final beginner tier. Solid competition — prove yourself here before advancing to medium.',         difficulty: 'Beginner',    color: 'bg-teal-500/10 border-teal-500/30 text-teal-400',     accentColor: '#14b8a6', borderAccent: '#0d9488', botsCount: 150, rewardMultiplier: 2.0 },

  // ── MEDIUM (Tiers 7–12): 500c to 15,000c ──
  { id: 'tier-7',  name: 'Silver Strip',      buyIn: 500,         description: 'A polished medium-stakes corridor with balanced competition and reliable food spawns.',                 difficulty: 'Medium',      color: 'bg-amber-500/10 border-amber-500/30 text-amber-400',   accentColor: '#f59e0b', borderAccent: '#d97706', botsCount: 150, rewardMultiplier: 2.5 },
  { id: 'tier-8',  name: 'Jade Corridor',     buyIn: 1_000,       description: 'Lush and dangerous. Mid-tier hunters roam freely through the jade-colored passages.',                   difficulty: 'Medium',      color: 'bg-amber-500/10 border-amber-500/30 text-amber-400',   accentColor: '#fbbf24', borderAccent: '#f59e0b', botsCount: 150, rewardMultiplier: 3.0 },
  { id: 'tier-9',  name: 'Amber Crossing',    buyIn: 2_000,       description: 'A golden intersection where fortunes shift quickly. Watch for coordinated bot ambushes.',                 difficulty: 'Medium',      color: 'bg-amber-400/10 border-amber-400/30 text-amber-300',   accentColor: '#fcd34d', borderAccent: '#fbbf24', botsCount: 150, rewardMultiplier: 3.5 },
  { id: 'tier-10', name: 'Gold Quarter',      buyIn: 4_000,       description: 'Affluent territory with premium food density. Expect coordinated bot packs defending star chips.',        difficulty: 'Medium',      color: 'bg-orange-500/10 border-orange-500/30 text-orange-400', accentColor: '#f97316', borderAccent: '#ea580c', botsCount: 150, rewardMultiplier: 4.5 },
  { id: 'tier-11', name: 'Ruby Den',           buyIn: 7_500,       description: 'Deep red arena with aggressive predators and scarce food. Only the cunning survive here.',             difficulty: 'Medium',      color: 'bg-orange-500/10 border-orange-500/30 text-orange-400', accentColor: '#fb923c', borderAccent: '#f97316', botsCount: 150, rewardMultiplier: 5.5 },
  { id: 'tier-12', name: 'Sapphire Hall',     buyIn: 15_000,      description: 'Elegant but deadly. The gateway to high-stakes play — blue crystalline walls refract light.',             difficulty: 'Medium',      color: 'bg-rose-500/10 border-rose-500/30 text-rose-400',     accentColor: '#f43f5e', borderAccent: '#e11d48', botsCount: 150, rewardMultiplier: 7.0 },

  // ── HIGH STAKES (Tiers 13–18): 30,000c to 750,000c ──
  { id: 'tier-13', name: 'Viper Pit',          buyIn: 30_000,      description: 'The viper syndicate\'s den. Elite bot AI with predictive dodging starts here.',                         difficulty: 'High Stakes', color: 'bg-rose-500/10 border-rose-500/30 text-rose-400',     accentColor: '#fb7185', borderAccent: '#f43f5e', botsCount: 150, rewardMultiplier: 8.0 },
  { id: 'tier-14', name: 'Championship Hub',   buyIn: 50_000,      description: 'Championship qualifier grounds. Extraction commission is heavily contested by skilled bots.',              difficulty: 'High Stakes', color: 'bg-pink-500/10 border-pink-500/30 text-pink-400',     accentColor: '#ec4899', borderAccent: '#db2777', botsCount: 150, rewardMultiplier: 10.0 },
  { id: 'tier-15', name: 'Emerald Court',     buyIn: 100_000,     description: 'A hundred-thousand buy-in. Only serious operators enter this prestigious emerald arena.',               difficulty: 'High Stakes', color: 'bg-pink-500/10 border-pink-500/30 text-pink-400',     accentColor: '#f472b6', borderAccent: '#ec4899', botsCount: 150, rewardMultiplier: 12.0 },
  { id: 'tier-16', name: 'Diamond Nexus',      buyIn: 200_000,     description: 'Brilliant and ruthless. High-value star drops attract fierce competition from all sides.',               difficulty: 'High Stakes', color: 'bg-violet-500/10 border-violet-500/30 text-violet-400', accentColor: '#8b5cf6', borderAccent: '#7c3aed', botsCount: 150, rewardMultiplier: 15.0 },
  { id: 'tier-17', name: 'Apex Vault',         buyIn: 350_000,     description: 'Three hundred fifty thousand to enter. The apex of mid-tier competition — only veterans tread here.',      difficulty: 'High Stakes', color: 'bg-violet-500/10 border-violet-500/30 text-violet-400', accentColor: '#a78bfa', borderAccent: '#8b5cf6', botsCount: 150, rewardMultiplier: 18.0 },
  { id: 'tier-18', name: 'Obsidian Core',      buyIn: 750_000,     description: 'Dark and unforgiving obsidian arena. One wrong move costs hundreds of thousands — precision is key.',    difficulty: 'High Stakes', color: 'bg-purple-500/10 border-purple-500/30 text-purple-400', accentColor: '#a855f7', borderAccent: '#9333ea', botsCount: 150, rewardMultiplier: 22.0 },

  // ── EXTREME (Tiers 19–24): 1,500,000c to 40,000,000c ──
  { id: 'tier-19', name: 'Crimson Abyss',      buyIn: 1_500_000,   description: 'A bottomless crimson arena where only the strongest survive. Bots are relentless hunters.',             difficulty: 'Extreme',     color: 'bg-purple-500/10 border-purple-500/30 text-purple-400', accentColor: '#c084fc', borderAccent: '#a855f7', botsCount: 150, rewardMultiplier: 28.0 },
  { id: 'tier-20', name: 'Shadow Realm',       buyIn: 3_000_000,   description: 'Shrouded in darkness. Predators hunt by prediction — stay mobile or become prey.',                    difficulty: 'Extreme',     color: 'bg-red-500/10 border-red-500/30 text-red-400',       accentColor: '#ef4444', borderAccent: '#dc2626', botsCount: 150, rewardMultiplier: 32.0 },
  { id: 'tier-21', name: 'Void Station',       buyIn: 5_000_000,   description: 'An orbital arena floating in the void. Zero room for error at a five-million buy-in.',                  difficulty: 'Extreme',     color: 'bg-red-500/10 border-red-500/30 text-red-400',       accentColor: '#f87171', borderAccent: '#ef4444', botsCount: 150, rewardMultiplier: 38.0 },
  { id: 'tier-22', name: 'Phantom Reach',      buyIn: 10_000_000,  description: 'Ghost-like operators compete for massive chip pools. Bots use advanced flanking tactics.',             difficulty: 'Extreme',     color: 'bg-red-600/10 border-red-600/30 text-red-500',       accentColor: '#dc2626', borderAccent: '#b91c1c', botsCount: 150, rewardMultiplier: 45.0 },
  { id: 'tier-23', name: 'Inferno Gate',       buyIn: 20_000_000,  description: 'Twenty million at stake. The heat is unbearable — bots charge aggressively on sight.',                 difficulty: 'Extreme',     color: 'bg-rose-600/10 border-rose-600/30 text-rose-500',     accentColor: '#e11d48', borderAccent: '#be123c', botsCount: 150, rewardMultiplier: 52.0 },
  { id: 'tier-24', name: 'Tartarus Pit',       buyIn: 40_000_000,  description: 'The deepest pit before legendary territory. Forty million to enter — only the elite survive.',         difficulty: 'Extreme',     color: 'bg-rose-600/10 border-rose-600/30 text-rose-500',     accentColor: '#f43f5e', borderAccent: '#e11d48', botsCount: 150, rewardMultiplier: 60.0 },

  // ── LEGENDARY (Tiers 25–30): 75,000,000c to 1,000,000,000c ──
  { id: 'tier-25', name: 'Venom Grand',         buyIn: 75_000_000,          description: 'The grand Venom arena. Only the wealthiest operators dare challenge at this level.',                 difficulty: 'Legendary',   color: 'bg-amber-500/10 border-amber-500/30 text-amber-400',   accentColor: '#f59e0b', borderAccent: '#d97706', botsCount: 150, rewardMultiplier: 70.0 },
  { id: 'tier-26', name: 'Omega Station',       buyIn: 150_000_000,         description: 'A hundred fifty million to enter. The stakes defy comprehension — every second is worth thousands.',    difficulty: 'Legendary',   color: 'bg-orange-500/10 border-orange-500/30 text-orange-400', accentColor: '#f97316', borderAccent: '#ea580c', botsCount: 150, rewardMultiplier: 80.0 },
  { id: 'tier-27', name: 'Singularity Core',    buyIn: 300_000_000,         description: 'A gravitational singularity arena. Three hundred million at stake — nothing escapes its pull.',         difficulty: 'Legendary',   color: 'bg-red-500/10 border-red-500/30 text-red-400',       accentColor: '#ef4444', borderAccent: '#dc2626', botsCount: 150, rewardMultiplier: 90.0 },
  { id: 'tier-28', name: 'Eternity Vault',      buyIn: 500_000_000,         description: 'Time stands still in this vault. Five hundred million at play — patience or aggression?',             difficulty: 'Legendary',   color: 'bg-rose-600/10 border-rose-600/30 text-rose-500',   accentColor: '#e11d48', borderAccent: '#be123c', botsCount: 150, rewardMultiplier: 100.0 },
  { id: 'tier-29', name: 'Abyssal Throne',      buyIn: 750_000_000,         description: 'The throne of the abyss. Seven hundred fifty million to challenge the king of the arena.',          difficulty: 'Legendary',   color: 'bg-yellow-500/10 border-yellow-500/30 text-yellow-400', accentColor: '#eab308', borderAccent: '#ca8a04', botsCount: 150, rewardMultiplier: 120.0 },
  { id: 'tier-30', name: 'The Singularity',     buyIn: 1_000_000_000,       description: 'The ultimate arena. One billion chips. Mythical territory where fortunes are made and destroyed in an instant.', difficulty: 'Legendary', color: 'bg-yellow-400/10 border-yellow-400/30 text-yellow-300', accentColor: '#facc15', borderAccent: '#eab308', botsCount: 150, rewardMultiplier: 150.0 },
];
