              ...
              <div className="md:col-span-8 flex flex-col gap-1">
                ...
                <div className="flex flex-col gap-0">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-1">
                    ...
                    <BentoGate onClick={() => setActiveTab('shop')} icon={ShoppingBag} accent="purple" badge="Customize Lab" title="Identity Workshop & Shop" desc="Free preset skins, premium character-face skins, face cosmetics and arena backgrounds — or design your own repeating body-segment DNA in the Genetic Lab." footLeft={`EQUIPPED: ${equippedSkinName(player.currentSkin)}`} footRight="Modify" />
