    ...
    <div className="space-y-1">
      ...
      <TwoColumnTable
        rows={[
          ...
          { label: 'Clan Deposits', value: 'Player-initiated deposits to clan treasury', note: 'no withdrawals yet' },
        ]}
      />
...
function SectionClanGovernance() {
  return (
    <div className="space-y-1">
      ...
      <SubHeading>Clan Deposits</SubHeading>
      <ul className="space-y-1.5 ml-1">
        <Bullet>
          Deposits are <strong className="text-slate-200">player-initiated</strong> — a member chooses how many chips to move from their personal bank to the clan treasury.
        </Bullet>
        <Bullet>
          <strong className="text-rose-400">No withdrawal system exists yet.</strong> Once deposited, chips stay in the clan treasury.
        </Bullet>
      </ul>
