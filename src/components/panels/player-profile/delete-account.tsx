...
export function DeleteAccountSection({
  ...
  return (
    <div className="rounded-xl border border-rose-500/30 bg-rose-950/20 p-5 lg:p-2">
      ...
      <div className="hidden lg:flex items-center justify-between">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <span className="text-[11px] font-bold text-rose-300 font-sans uppercase tracking-wider truncate">
            Danger Zone
          </span>
        ...
        <AlertDialog>
          <AlertDialogTrigger asChild>
            <button
              type="button"
              disabled={deleting}
              className="shrink-0 ml-3 px-3 py-1 bg-rose-600/20 hover:bg-rose-600/30 border border-rose-500/30 text-rose-400 hover:text-rose-300 rounded-lg text-[11px] font-bold transition cursor-pointer flex items-center gap-1.5 disabled:opacity-50"
            >
